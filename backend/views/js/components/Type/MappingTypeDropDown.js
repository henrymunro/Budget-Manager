...
import {
  ...
  updateMappingIDToExpandTypeDropDown
} from '../../actions/mappingsActions'


export default class MappingTypeDropDown extends React.Component {
  ...
  onDropDownTypeChange(e){
    ...
    this.props.dispatch(saveNewSelectedType(selectedType, selectedSubType, this.props.UserMapping_id, this.props.axios))
        .then((res)=>{
          this.props.dispatch(updatedSelectedType(selectedType, selectedSubType, this.props.UserMapping_id))
        }).catch((err)=>{
  ...
  toggleDropDown(e){
    this.props.dispatch(updateMappingIDToExpandTypeDropDown(this.props.UserMapping_id))
  }
  collapseAllDropDowns(e){
    this.props.dispatch(updateMappingIDToExpandTypeDropDown(-1))
  }
